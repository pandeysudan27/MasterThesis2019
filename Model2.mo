package Model2 "Model of Thermal cooled Synchronous Generator"
  /*
 ...
 */
	...
	model ModGenerator
		...
		//
		parameter Real Rr=0.16e-3 "Ohmic resistance,rotor copper,kOhm, at 25 C";
		parameter Real Rs=3.5e-6 "Ohmic resistance,stator copper,kOhm, at 25 C";
		...
		parameter Real Hhr0=HhCu_o+chpCu*(Tr0-TCu_o) "Initial rotor specific enthalpy,kJ/kg";
		parameter Real Hhs0=HhCu_o+chpCu*(Ts0-TCu_o) "Initial stator copper specific enthalpy,kJ/kg";
		parameter Real HhFe0=HhFe_o+chpFe*(TFe0-TFe_o) "Initial stator iron specific enthalpy,kJ/kg";
		...
		// -- heat rates
		Qdrs=1.1* Rr*(1+alpha*(Tr-TCu_o))*Ifd ^2;
		//Rrt=Rr*(1+alpha*(Tr-TCu_o));
		Qdss=3* Rs*(1+alpha*(Ts-TCu_o))*It ^2;
